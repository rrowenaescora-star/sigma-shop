  ...
  return (
    <main className="min-h-screen bg-[#06101d] px-6 py-12 text-white">
      <section className="mx-auto max-w-5xl">
        ...
        <p className="mt-6 leading-8 text-slate-400">Bloxhop provides digital gaming-related products and services through an online store, with product information, online checkout, payment confirmation, digital fulfillment, order tracking, and customer support.</p>

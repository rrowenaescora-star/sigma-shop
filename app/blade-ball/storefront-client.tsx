...
useEffect(() => {
  ...
  async function loadProducts() {
    try {
      ...
      const response = await fetch("/api/products?game=blade-ball", { cache: "no-store" });
      ...
      const bladeBallProducts = (result.products || []).filter(
  (product: Product) => product.game === "blade-ball"
);

setProducts(bladeBallProducts);

...
useEffect(() => {
  ...
  async function loadProducts() {
    try {
      ...
      const response = await fetch("/api/products?game=grow-a-garden-2", { cache: "no-store" });

      ...
      <div className="relative mx-auto max-w-[1700px] px-4 py-4 md:px-6 lg:px-8">
        <div className="mb-4 flex items-center justify-between rounded-3xl border border-slate-700/60 bg-[#0f1b2d]/95 px-4 py-4 backdrop-blur-xl">
          <div className="flex items-center gap-3">
            <p className="text-xl font-black tracking-tight">BLOXHOP ONLINE STORE</p>
...
return (
  <div
    key={product.id}
    className="group overflow-hidden rounded-[2rem] border border-slate-600/60 bg-[#07111f] shadow-[0_18px_50px_rgba(0,0,0,0.45)] transition-all duration-300 ease-out hover:-translate-y-1.5 hover:border-blue-400/40"
  >
    ...
    Only a few left — high demand
      ...
      <div className="mt-5">
        ...
        <button
          ...
          className={`mt-5 w-full cursor-pointer rounded-2xl px-5 py-4 text-base font-bold transition ${
            outOfStock

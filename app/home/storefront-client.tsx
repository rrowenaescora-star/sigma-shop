...
useEffect(() => {
  ...
  async function loadProducts() {
    try {
      ...
      const response = await fetch("/api/products?game=blox-fruits", { cache: "no-store" });
     ...
     (product: Product) => product.game === "blox-fruits"
 );
...
if (foundProduct) {
  ...
  return (
    <div className="relative min-h-screen bg-[#07111f] bg-[url('/website-background.png')] bg-cover bg-center bg-fixed text-white">
  ...
  <div className="mx-auto grid max-w-4xl gap-4">
    {[
      ...
      },
      {
        ...
        a: "Digital orders are typically fulfilled within approximately 2–3 minutes after successful payment verification under normal conditions. Actual fulfillment time may vary depending on payment verification, product availability, order volume, customer information, platform limitations, and technical circumstances.",
      },
      {

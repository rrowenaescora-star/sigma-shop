...
const featuredProducts = [
  ...
  { id: 3, name: "Permanent Kitsune", image: "/kitsune12.webp", hoverImage: "/Kitsune_Fruit.webp", href: "/home#permanent-kitsune" },
...
export default function LandingPage({ initialFeaturedImages }: { initialFeaturedImages: Record<string, string> }) {
  const [openFaq, setOpenFaq] = useState<number | null>(0);
  const liveFeaturedImages = initialFeaturedImages;
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#06101d] text-white">
      ...
      <section className="group relative overflow-hidden border-b border-white/10 bg-[#06101d]">
        <img src="/bloxhop-header-background.webp" alt="" aria-hidden="true" className="pointer-events-none absolute inset-0 h-full w-full object-cover object-center opacity-80" />
...
Request an Item
            ...
            >
              <img src="/magnetfruit.webp" alt="" aria-hidden="true" className="absolute inset-0 -z-10 h-full w-full object-cover object-right opacity-75 transition duration-500 group-hover/new-fruit:scale-105" />
              ...
              {[
                {
                  ...
                  image: "/how-it-works/choose-your-items.webp",
                },
                {
